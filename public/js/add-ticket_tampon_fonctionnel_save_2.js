document.addEventListener('DOMContentLoaded', function() {
                ...
                <div class="d-flex align-items-center top-name">
                    <div class="icon-box">
                        ...
                        <h5 class="fs-16 mb-1 mt-1">
                            ...
                            <span class="discounted-price">${discountedPrice !== originalPrice ? discountedPrice.toFixed(2) + '€' : ''}</span>
                            <span class="discount-end-date">${discountEndText}</span> <!-- Affichage de la date de fin de réduction -->
                        </h5>
    ...
    function updateTicket(ticketItem) {
        ...
        ticketItem.querySelector('.top-name h5').innerHTML = `
            ...
            <span class="original-price">${originalPrice.toFixed(2)}€</span> 
            <span class="discounted-price">${discountedPrice !== originalPrice ? discountedPrice.toFixed(2) + '€' : ''}</span>
            <span class="discount-end-date">${discountDateText}</span>
        `;
